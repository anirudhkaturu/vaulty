  ...
  <nav className="fixed top-0 w-full z-50 border-b border-slate-200/50 bg-white/70 backdrop-blur-xl transition-all">
    ...
    <div className="max-w-7xl mx-auto px-6 h-14 flex items-center justify-between relative">
      ...
      <motion.div
        ...
        className="flex items-center gap-2 font-bold text-xl text-indigo-950 cursor-pointer z-10"
      >
      ...
      {/* --- CENTERED NAV LINKS --- */}
      {/* absolute positioning ensures it stays centered regardless of logo/button width */}
      ...
      <div className="flex items-center gap-2 z-10">
        <button className="hidden sm:block text-[13px] font-bold text-slate-600 px-4 py-2 rounded-lg border border-transparent hover:border-slate-200 hover:bg-slate-50/50 hover:text-indigo-600 transition-all active:scale-95">
          Login
        </button>
